...
const config = {
  ...
  tagline: 'Practical Flask backend training focused on clean architecture, scalability, and real-world implementation patterns.',
    ...
    [
      ...
      ({
        docs: {
          ...
          routeBasePath: '/',
          editUrl:
            'https://github.com/mittalpatel/flask-training/tree/main/',
        },
        blog: false,
        theme: {
